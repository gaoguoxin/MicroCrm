class Admin::UsersController < Admin::AdminController
  ...
  def update_info
    render_json_auto User.update_info(user_params,@company,current_user.id.to_s)
  end
  ...
  private
    ...
    def user_params
      params.require(:user).permit(:name, :email, :mobile, :password, :role_of_system, :type_of_position, :company_id, :city, :status, :ax, :crm, :softskill, :course_count, :course_manday_count)
    end
end
