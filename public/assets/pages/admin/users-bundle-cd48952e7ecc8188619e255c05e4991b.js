(function() {
  $(function() {
    ...
    $('body').on('click', '.pagination a', function() {
      var city, company, creater, email, end, g_data, interest, name, page, position, role, start, status;
      if (!$(this).hasClass('disabled')) {
        ...
        if (page) {
          return $.get("/admin/users", g_data, function() {});
        }
      }
    });
    ...
    return $('body').on('click', 'a.edit-user', function(e) {
      var cid;
      cid = $(this).attr('id');
      return $.get("/admin/users/" + cid + "/edit", {}, function(ret) {});
    });
  });
